...
**Depends on:** Story X.Y, Story Z.W (or "none") — _stories that must be done before this one_
**Parallelizable with:** Story N.M, Story P.Q — _stories that can be developed in parallel by another agent_
**Lane:** A | B | C (optional) — _for assigning to an agent lane_
