...
<activation critical="MANDATORY">
  ...
  <step n="5">Load project-context.md and architecture.md if available (see _bmad-output/project-context.md and _bmad-output/planning-artifacts/architecture.md) and follow their guidance - when conflicts exist, story requirements always take precedence</step>
